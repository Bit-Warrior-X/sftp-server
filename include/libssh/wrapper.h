...
int evp_dup_dsa_pkey(const ssh_key key, ssh_key new_ssh, int demote);
int evp_dup_rsa_pkey(const ssh_key key, ssh_key new_ssh, int demote);
int evp_dup_ecdsa_pkey(const ssh_key key, ssh_key new_ssh, int demote);
